...
python src/fine_tune.py --experiment 3 --lr 0.00005 --epochs 10 --model_name oneformer_ade20k_swin_large --balancing True --data_augmentation True #oneformer_coco_swin_large
