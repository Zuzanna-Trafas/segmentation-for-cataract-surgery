...
python3 src/pupil_size_calculator.py --input_label_folder="/home/data/CaDISv2/Video01/Labels" --input_original_folder "/home/data/CaDISv2/Video01/Images" --output_folder="/home/guests/dominika_darabos/segmentation-for-cataract-surgery/samples/proba" --change_threshold=30 --purpose="comparison"